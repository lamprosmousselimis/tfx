...
class Metadata(object):
  ...
  def get_qualified_artifacts(
    ...
    for context in contexts:
      ...
      execution_id_sets.append(set(e.id for e in  executions))
      executions_dict.update(dict((e.id, e) for e in executions))

    executions_ids = set.intersection(*execution_id_sets)
    executions_within_context = [executions_dict[eid] for eid in executions_ids]
